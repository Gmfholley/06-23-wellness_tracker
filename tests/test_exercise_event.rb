...
class ExerciseEventTest < Minitest::Test
  ...
  def test_initialize
    exercise_event = ExerciseEvent.new("id" => 1, "date" => "today", "person_id" => "1", "intensity_id" => "2", 
    "duration_id" => "3", "exercise_type_id" => "4")
    
    assert_equal(Chronic.parse("today").to_date.strftime("%m/%d/%y"), exercise_event.date_humanized)
  ...
  def test_changes_to_foreign_keys
    ...
    assert_equal(Chronic.parse("yesterday").to_date.strftime("%m/%d/%y"), exercise_event.date_humanized)
 ...
 #
  def test_crud
    m = ExerciseEvent.new(id: 1, date: "today", person_id: "1", intensity_id: "2", 
    duration_id: "3", exercise_type_id: "4")
  ...
  def test_valid
    ...
    m = ExerciseEvent.new(id: 1, date: "today", person_id: 0, intensity_id: 0, 
    ...
    m = ExerciseEvent.new(id: 1, date: "today")
